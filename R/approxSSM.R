...
#' 
#' The linear Gaussian approximating model is defined by \deqn{\tilde y_t = Z_t 
#' \alpha_t + \epsilon_t, \quad \epsilon_t \sim N(0,\tilde H_t),}{ ytilde[t] = 
#' Z[t]\alpha[t] + \epsilon[t], \epsilon[t] ~ N(0,Htilde[t]),} 
